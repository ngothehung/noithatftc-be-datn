...
const Dashboard = () => {
	...
	const totalRevenue = dataRevenue.reduce((acc, current) => acc + current, 0);
						...
						<Row className="gutter mb-4">
							...
							<Col className="my-4 pr-0 mb-md-0" xs={12} md={12}>
								...
								<div className="total-revenue">
									<p className="headline-3">Tổng tiền doanh thu: {new Intl.NumberFormat('en-US').format(totalRevenue)} VND</p>
								</div>
							</Col>
